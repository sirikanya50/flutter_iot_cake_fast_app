...
class _CakShoopListUiState extends State<CakShoopListUi> {
  ...
  List<CakeShop> cakeShops = [
    CakeShop(
      ...
      openingCloseTime: 'ทุกวัน 10.00-20.00 น.',
    ...
    CakeShop(
      ...
      openingCloseTime: 'ทุกวัน 09.00-19.00 น',
    ...
    CakeShop(
      ...
      openingCloseTime: 'ทุกวัน 09.00-21.00 น.',
    ...
    CakeShop(
      ...
      openingCloseTime: 'ทุกวัน 07.30-19.30 น.',
    ...
    CakeShop(
      ...
      openingCloseTime: 'ทุกวัน 10.00-22.00 น.',
    ...
    CakeShop(
      ...
      openingCloseTime: '10.00-18.00 น. \n(หยุดวันอาทิตย์)',
